...
3.  Bảng điều khiển sẽ xuất hiện. Nhấp vào **Start** bên cạnh **Apache** và **Start** bên cạnh **MySQL**.
    _(Nếu Windows Firewall nhắc bạn, hãy nhấp vào "Allow access")._
...
### Bước 9: Cấu hình Đường dẫn Chính cho TCExam

Chúng ta cần đảm bảo đường dẫn chính trong TCExam được thiết lập chính xác.

1.  Trong cùng thư mục `E:\xampp\htdocs\tcexam\shared\config`, mở tệp **`tce_paths.php`** bằng trình soạn thảo văn bản.
2.  Tìm dòng chứa `K_PATH_MAIN` và thay đổi đường dẫn thành như sau:
    ```php
...
6.  _Khi kết thúc:_ Dừng các máy chủ trong bảng điều khiển trước khi rút USB.
