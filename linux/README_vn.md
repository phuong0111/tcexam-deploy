# Triển khai TCExam trên Linux

[English](README.md) | [🇻🇳 Tiếng Việt](README_vn.md)

## Cài đặt & Thiết lập

Thực hiện theo các bước sau để thiết lập môi trường triển khai TCExam trên Linux sử dụng Docker:
...
5. **Điều hướng đến thư mục cấu hình Linux:**
```bash
cd ../linux
```
